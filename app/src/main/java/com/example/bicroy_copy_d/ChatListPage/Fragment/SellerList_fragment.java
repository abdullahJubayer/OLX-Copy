...
public class SellerList_fragment extends Fragment implements ItemClickListner {

    RecyclerView recyclerView;
    ChatListRecyclerAdapter chatListRecyclerAdapter;
    Context context;

    public SellerList_fragment(){}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_seller_list_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.seller_list_recycler_view);
